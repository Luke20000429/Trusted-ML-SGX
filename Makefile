...
SGX_COMMON_FLAGS += -Wall -Wextra -Winit-self -Wpointer-arith -Wreturn-type \
                    ...
                    -Wcast-align -Wcast-qual -Wconversion -Wredundant-decls -fopenmp
SGX_COMMON_CFLAGS := $(SGX_COMMON_FLAGS) -Wjump-misses-init -Wstrict-prototypes -Wunsuffixed-float-constants -lstdc++
...
App_Cpp_Flags := $(App_C_Flags) $(SGX_COMMON_CXXFLAGS) -fopenmp
App_C_Flags += $(SGX_COMMON_CFLAGS)
App_Link_Flags := -L$(SGX_LIBRARY_PATH) -l$(Urts_Library_Name) -lpthread -lm -lgomp
...
Enclave_Link_Flags := $(Enclave_Security_Link_Flags) \
	...
	-Wl,-pie,-eenclave_entry -Wl,--export-dynamic -Wl,--defsym,__ImageBase=0 -Wl,--gc-sections --verbose # -Wl,--gc-sections must be set
